    ...
    if d_args['sample_columns']:
        ...
        with open_haps(d_args['haplotypes']) as f:
            if d_args['haps']:
                ...
                stoptmp
    n_hap = 2*len(cols)
    print('{:d} haplotypes'.format(n_hap), flush=True)
...
#            print(pos1,A1,B1)
            ...
            for line2 in fd_hap2:
                ...
                if (pos1,A1,B1) == (pos2,A2,B2):
                    ...
                    if bool_parse_line2:
                        l_haps2 = parse_hap(line2, cols)
                    ## Second slowest step of the entire script.
...
def argparser():
    ...
    parser.add_argument('--pos_min','--pos1', default=1, type=int)
    ...
    parser.add_argument('--window', type=int, default=250000, help='bp (not kbp)')
